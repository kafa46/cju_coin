...
$(function(){
    ...
    $('#mining_start').on('click', function(e){
        ...
        // 채굴 중단 버튼을 클릭했을 때 보여줄 메시지 숨기기
        $('#msg_for_stop_mining').attr('hidden', true);
        // 채굴이 완전히 중단되었을 때 보여줄 메시지 숨기기
    ...
    $('#mining_stop').on('click', function(){
        ...
        $.ajax({
            ...
            error: function(response, staus_code, error){
                console.log('에러가 발생했어요 ㅠㅠ')
                console.log(error)
            }
        });
    });
